...
def content2tensor(content):
    ...
    content2vec_r=content.reshape(-1,1,vector_l*2)
...
rnn=RNN(vector_l*2,n_hidden,n_values)
def TrainingExample(i):
    category=sentiment_value[i]
    line=content[i]
...
for iter in range(30000):
    category, line, category_tensor, line_tensor = TrainingExample(random.randint(0,len(content)-1))
    output, _ = train(category_tensor, line_tensor)
